...
<div class="container">
    ...
    <h5 class="text-center">Nombre, ciudad y pais de los 10 aeropuertos de los que mas personas parten hacia algun destino.</h5>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function generarGrafico(tipo) {
                ...
                var etiquetas = data.map(function (elemento) {
                    return elemento.aweopuerto + ' (' + elemento.ciudad + ')' + ' '+ elemento.pais +'';
                });
