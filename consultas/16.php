...
<div class="container">
    ...
    <h5 class="text-center">Nombre del o los aeropuertos de los que menos personas parten. Muestro la ciudad y el pais al que pertenece.</h5>
    ...
    c.nombre AS ciudad,
    p.nombre AS pais,
    COUNT(*) AS total_personas_parten
FROM
    detalle_vuelos dv
INNER JOIN
...
GROUP BY
    a.nombre, c.nombre, p.nombre
ORDER BY
    total_personas_parten;";
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function generarGrafico(tipo) {
                ...
                var etiquetas = data.map(function (elemento) {
                    return elemento.aeropuerto + ' (' + elemento.ciudad + ')' + '' + elemento.pais +'';
                });
                var valores = data.map(function (elemento) {
                    return elemento.total_personas_parten;
                });
