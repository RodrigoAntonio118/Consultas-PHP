...
<div class="container">
    ...
    <h5 class="text-center">Numero de personas que viajaron de cada combinacion municipios, estados.</h5>
...
FROM 
    ocupaciones o
INNER JOIN 
    clientes c ON c.cve_clientes = o.cve_clientes
INNER JOIN 
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function generarGrafico(tipo) {
                ...
                var etiquetas = data.map(function (elemento) {
                    return elemento.estado + ' (' + elemento.municipio + ')';
                });
