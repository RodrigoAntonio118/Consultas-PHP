...
<div class="container">
    ...
    <h5 class="text-center">Numero de vuelos por cada mes / año.</h5>
    ...
    MONTH(dv.fecha_hora_salida) AS mes,
    COUNT(*) AS numero_vuelos
FROM
    detalle_vuelos dv
GROUP BY
    YEAR(dv.fecha_hora_salida), MONTH(dv.fecha_hora_salida)
ORDER BY
    año, mes;";
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function generarGrafico(tipo) {
                ...
                var etiquetas = data.map(function (elemento) {
                    return elemento.año + ' (' + elemento.mes + ')';
                });
