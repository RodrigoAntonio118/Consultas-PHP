...
<div class="container">
    ...
    <h5 class="text-center">Numero de personas que viajaron de acuerdo a su categoria: Niños hasta 12 años, adolescentes de 13 a 17 años, jovenes de 18 a 30 años, adultos de 30 a 59 años y adultos mayores de 60 en adelante.</h5>
    ...
    CASE
        ...
        WHEN DATEDIFF(YEAR, c.fecha_nacimiento, GETDATE()) BETWEEN 18 AND 30 THEN 'Jovenes de 18 a 30 años'
        WHEN DATEDIFF(YEAR, c.fecha_nacimiento, GETDATE()) BETWEEN 31 AND 59 THEN 'Adultos de 31 a 59 años'
        ELSE 'Adultos mayores de 60 en adelante'
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function generarGrafico(tipo) {
                ...
                var etiquetas = data.map(function (elemento) {
                    return elemento.categoria_edad;
                });
