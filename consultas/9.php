...
<div class="container">
    ...
    <h5 class="text-center">Numero de vuelos realizados por aerolinea, por cada año.</h5>
...
INNER JOIN
    aerolineas a ON v.cve_aerolineas = a.cve_aerolineas
GROUP BY
    a.nombre,
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function generarGrafico(tipo) {
                ...
                var etiquetas = data.map(function (elemento) {
                    return elemento.aerolinea + ' (' + elemento.año + ')';
                });
